...
|gprs_test_start_time|否|gprs测试开始时间|
|gprs_test_end_time|否|gprs测试结束时间|
|gprs_test_result|否|gprs测试结果|
|gprs_test_status|否|gprs测试状态|
|lora_test_start_time|否|lora测试开始时间|
|lora_test_end_time|否|lora测试结束时间|
|lora_test_result|否|lora测试结果|
|lora_test_status|否|lora测试状态|
|remarks|否|评论|
|online|否|在线|
